...
const AreaOfSupportDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-deep-teal via-emerald-700 to-sky-600 py-16 min-h-[400px] flex items-center">
        <div 
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-deep-teal to-sky-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/contact" 
              className="bg-white text-teal-accent px-8 py-4 rounded-lg font-semibold hover:bg-soft-mint transition-colors"
            >
              Book Free Consultation
            </Link>
            <Link 
              to="/" 
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-teal-accent transition-colors"
            >
